...
0 + 1 = 1 1 + 1 = 2 1 + 2 = 3 2 + 3 = 5 3 + 5 = 8 5 + 8 = 13 8 + 13 = 21 13 + 21 = 34 21 + 34 = 55 """ Program to display the Fibonacci sequence up to n-th term
...
if __name__ == "__main__":
    ...
    print(Person.info())
22.Reverse a string Input s = "hello" Output "olleh"

a="hello"
b=a[::-1]
print(b)
23.Check if a number is prime Input num = 13 Output True # 13 is a prime number
...
n = 13
print(is_prime(n))
24.Count the number of vowels in a string Input sentence = "hello world" Output 3 # 'e', 'o', 'o' are vowels
...
for i in sentence:
    if i == "a" or i == "e" or i == "i" or i == "o" or i == "u":
        a.append(i)
print(a)
25.Sum all numbers in a list Input numbers = [1, 2, 3, 4] utput 10 # 1+2+3+4
...
for i in number:
    add=add+i
print(add)
26. Find the GCD of two numbers Input a = 24 b = 36 Output 12 # GCD of 24 and 36
...
print(gcd)
27.Convert Celsius to Fahrenheit Input celsius = 25 Output 77.0 # Fahrenheit equivalent of 25°C
...
28.Calculate the area of a circle given the radius Input radius = 5 Output 78.54 # Area = πr^2
...
data=circle(5)
print(data)
29.Generate a list of squares for numbers from 1 to 5 Input n = 5 Output [1, 4, 9, 16, 25]
...
for i in range(1,6):
    ...
    a.append(square)
print(a)
30.Convert a string to lowercase Input s = "HELLO" Output "hello"

s="HELLO"
print(s.lower())
31.Find the length of a string Input s = "python" Output 6

a="python"
print(len(a))
32.Check if a year is a leap year Input year = 2024 Output True # 2024 is a leap year
...
33.Sort a list of numbers in ascending order Input numbers = [5, 2, 9, 1, 5] Output [1, 2, 5, 5, 9]

num=[5,2,9,1,5]
a=sorted(num)
print(a)
34.Find the sum of digits of a number Input num = 123 Output 6 # 1+2+3
...
def add(num):
    ...
    print(sum)
add(123)
35. Remove duplicates from a list Input numbers = [1, 2, 2, 3, 4, 4, 5] Output [1, 2, 3, 4, 5]
